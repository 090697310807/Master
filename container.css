...
.support img:hover, .support_2 img:hover,
...
#adcopy_response {color:#000}
button + small, .fcbtn + small {display: block;margin:10px auto}

/* Header */
.top{position:relative;width:100%;overflow:hidden;min-width:1000px;height:80px;z-index:10;background:#1B91DB}
.top .box{position:relative;max-width:1500px;min-width:900px;margin:0 auto;width:auto;padding:0 30px;box-sizing:border-box}
.top svg{position:relative;fill:#fff;height:25px;max-width:25px;top:5px}
div.cle:after{content:"";display:block;float:none;clear:both}
button.close svg{position:absolute;height:14px;width:14px;left:5px;top:4px}
.minibox a.user svg{margin-right:5px}
svg.logo{position:absolute;height:44px;max-width:32px;top:18px;left:35px}
.top h1.logo{position:relative;margin:0;padding-left:45px;font-size:30px;font-weight:300;color:#fff;height:80px;line-height:80px;float:left}
.top ul{position:relative;margin:0;padding:0;height:100%;line-height:80px}
.top ul li{margin-left:24px;color:#fff;font-size:15px;float:left}
...
.minibox{position:relative;max-width:200px;float:right;height:100%;line-height:80px;color:#fff}
.minibox a.user{padding:5px 0;font-weight:600;color:#fff}
.minibox button.close{position:absolute;top:-1px;right:0;width:26px;height:23px;border-radius:0 0 4px 4px;border:1px solid rgba(0,0,0,.1);background:rgba(0,0,0,.1);opacity:.8}
...
.window{position:relative;height:calc(100vh - 80px);width:100%;text-align:center;cursor:default;box-sizing:border-box;padding:20px 45px 45px 45px;}
...
.container.window .topback{position:absolute;top:0;left:0;height:100px;width:100%}
.container.window .topback svg{height:156px;width:95%;margin:-75px auto 0}
...
.container .support,
.container .support_2{margin:0 auto 30px;max-width:900px;width:80%;z-index: 33;position: relative;}
.container.window table{border-spacing:0;margin:0 auto;min-width:728px;width:80%;max-width:900px}
.container tr td{padding:10px 0;font-size:14px;height:50px;box-sizing:border-box}
...
.container tr td:nth-child(4){width:110px;text-align:center}
...
.container small{opacity:.6;font-size:12px}
.container tr td:nth-child(2) span{font-size:11px;display:block;font-weight:normal;opacity:.75;text-align:left}
.container .buttons{display:block;width:100%;margin:10px auto 30px}
.container .buttons button{position:relative;width:auto;height:36px;padding:0 10px}
...
/* Download Buttons */
button, .fcbtn{background:#1fa1e1;font-size:14px;color:#fff;padding:5px 10px}
...
.container button.dlcdownload{left:-4px;border-radius:0 2px 2px 0;border-left:1px dashed #55b226}
.container.window table button{padding:0;width:90px;height:32px;display:block;line-height:32px;margin:0 auto;font-weight:normal;}
html:lang(en) .container button.streamed:hover:after,
html:lang(en) .container button.stream:after{content:"watch";display:block;font-weight:normal}
html:lang(de) .container button.streamed:hover:after,
html:lang(de) .container button.stream:after{content:"Ansehen";display:block;font-weight:normal}
.container button.download:after{content:"Download";display:block;font-weight:normal}
.container button.streamed:after,
.container button.downloaded:after{content:url('../images/downloaded.png');display:block;margin-top:2px}
.container button.downloaded:hover:after{content:"Download";margin-top:0;}
...
.buttons svg{position:absolute;fill:#fff;pointer-events:none}
button#cnl_btn svg{height:27px;max-width:28px;top:4px}
button.dlcdownload svg{height:17px;max-width:19px;top:9px}
.hghspd{height:20px;max-width:12px;top:8px;left:20px}
...
.errpage{background:#e9f3f9;height: calc(100vh - 80px);}
...
.protection ul{background:#07629a;padding: 20px;display: flex;color:#fff;justify-content: center;}
.protection ul li{align-items:center;display:flex;}
...
.set2 li:last-child,
.set3 li:last-child{width: auto;display:flex;flex:1 1 auto;height:100%;align-self: center;justify-content: space-between;flex-direction: column;    align-items: center;}
...
@media only screen and (max-width: 640px) {
    html, body, .container .support,.container .support_2, .top .box, .top, .big .box, .container.window table, .content.big {
        max-width: 640px;
        min-width: 320px;
        width: 100%;
    }
    ...
    .top h1.logo {
    height: 50px;
        line-height: 50px;font-size: 24px;padding-left: 25px;}
    .protection li {
    }
    ...
    .protection h2 + hr + p {font-size:14px;}
    form.cnlform {
        display: flex;
    }
    ...
    .protection a img,
    .container .support img,.container .support_2 img  {
        max-width: 100%;
        overflow: hidden;
        margin:0 auto;
    }
    ...
    .container.window table button {width:80px;}

    .container .buttons button,.container button {height:40px;}
    .window {
    ...
    .protection ul{width:100%;max-width:360px;margin:0 auto;box-sizing:border-box;}
    .set2 li:last-child, .set3 li:first-child {width:100%;}
}
